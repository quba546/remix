...
<div class="bg-light border-right" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
        ...
        <a href="{{route('admin.match.last')}}" class="list-group-item list-group-item-action bg-light">Ostatni mecz</a>
        <a href="{{route('admin.match.upcoming')}}" class="list-group-item list-group-item-action bg-light">Najbliższy mecz</a>
        <a href="{{route('admin.table')}}" class="list-group-item list-group-item-action bg-light">Tabela</a>
