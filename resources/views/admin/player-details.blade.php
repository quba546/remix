...
@section('content')
    <x-admin-pages-template title="Profil zawdodnika" cardHeader="Edytuj dane zawodnika">
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('admin.players.update', ['player' => $player->id]) }}"
                        ...
                        <div class="form-row ml-2 mr-2">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="circular--portrait">
                                            <img
                                                src="{{ isset($player->image) ? asset('storage/' . $player->image) : asset('storage/blank-profile-picture.png') }}"
                                                class="img-scorer" alt="Zdjęcie gracza">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-12 col-xl-6">
                                ...
                                <input readonly type="text" name="id"
                                       value="{{ $player->id ?? '' }}" class="form-control" id="id">
                                ...
                                <select name="position" class="form-control" id="position" required>
                                    ...
                                    @if($position !== 'bramkarz')
                                        <option value="bramkarz">bramkarz</option> @endif
                                    @if($position !== 'obrońca')
                                        <option value="obrońca">obrońca</option> @endif
                                    @if($position !== 'pomocnik')
                                        <option value="pomocnik">pomocnik</option> @endif
                                    @if($position !== 'napastnik')
                                        <option value="napastnik">napastnik</option> @endif
                                </select>
                                @error('position')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="form-row ml-2 mr-2 pt-2">
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="played_matches"
                                       value="{{ old('played_matches') ?? $player->played_matches ?? '' }}"
                                       class="form-control @error('played_matches') is-invalid @enderror"
                                       id="playedMatches" placeholder="0" min="0" step="1">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="goals"
                                       ...
                                       id="goals" placeholder="0" min="0" step="1">
                                @error('goals')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="assists"
                                       ...
                                       id="assists" placeholder="0" min="0" step="1">
                                @error('assists')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-row ml-2 mr-2">
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="clean_sheets"
                                       value="{{ old('clean_sheets') ?? $player->clean_sheets ?? '' }}"
                                       class="form-control @error('clean_sheets') is-invalid @enderror"
                                       id="cleanSheets" placeholder="0" min="0" step="1">
                                @error('clean_sheets')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="yellow_cards"
                                       value="{{ old('yellow_cards') ?? $player->yellow_cards ?? '' }}"
                                       class="form-control @error('yellow_cards') is-invalid @enderror"
                                       id="yellowCards" placeholder="0" min="0" step="1">
                                @error('yellow_cards')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="red_cards"
                                       value="{{ old('red_cards') ?? $player->red_cards ?? '' }}"
                                       class="form-control @error('red_cards') is-invalid @enderror"
                                       id="redCards" placeholder="0" min="0" step="1">
                                @error('red_cards')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-row ml-2 mr-2">
                            <div class="form-group col-md-6">
                                ...
                                <input readonly type="text" name="created_at"
                                       value="{{ \Carbon\Carbon::parse($player->created_at ?? '')->format('d-m-Y G:i:s') }}"
                                       class="form-control" id="createdAt">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="updatedAt" class="mb-0">Ostatnio edytowano</label>
                                <input readonly type="text" name="updated_at"
                                       value="{{ \Carbon\Carbon::parse($player->updated_at ?? '')->format('d-m-Y G:i:s') }}"
                    ...
                    <div class="row m-2">
                        <div
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="staticBackdropDeletePhoto"
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="staticBackdropLabel">
                                                Potwierdzenie usunięcia zdjęcia zawodnika</h5>
                                        ...
                                        <div class="modal-body">
                                            <p>Czy na pewno chcesz usunąć zdjęcie tego
                                                zawodnika?</p>
                                            <form
                                                action="{{ route('admin.players.destroy.image', ['player' => $player->id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                        ...
                        <div
                            ...
                            <button type="button" class="btn btn-outline-primary"
                                    data-toggle="modal"
                                    data-target="#staticBackdropRestoreDefaults">Zresetuj dane
                            </button>

                            <!-- Modal -->
                            <div class="modal fade" id="staticBackdropRestoreDefaults"
                                 data-backdrop="static" data-keyboard="false" tabindex="-1"
                                 aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Czy na pewno chcesz przywrócić domyślne wartości
                                                danych tego zawodnika?</p>
                                            <form
                                                action="{{ route('admin.players.restore', ['player' => $player->id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('PUT')
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit"
                                                            class="btn btn-outline-primary">Zresetuj
                                                        dane
                                                    </button>
                                                </div>
                                            </form>
                        ...
                        <div
                            class="form-group col-12 col-lg-4 d-flex justify-content-center justify-content-lg-end">
                        @can('admin-level')

                            <!-- Button trigger modal -->
                                <button type="button" class="btn btn-outline-danger"
                                        data-toggle="modal"
                                        data-target="#staticBackdropDeletePlayer">Usuń zawodnika
                                </button>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form
                                                    action="{{ route('admin.players.destroy', ['player' => $player->id]) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <div class="modal-footer">
