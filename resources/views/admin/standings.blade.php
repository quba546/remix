                            ...
                            <div class="form-row ml-2 mr-2">
                                <div class="form-group col-12 d-flex justify-content-end">
                                    @can('admin-level')
                                        ...
                                        <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#staticBackdropDeletePlayer">Wyczyść tabelę</button>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="staticBackdropLabel">Wyczyść tabelę ligową</h5>
