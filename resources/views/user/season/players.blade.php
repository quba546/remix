                    ...
                    <div class="col-12 col-lg" data-aos="fade-down" data-aos-duration="1000">
                        <a href="{{ route('season.players.show', ['player' => $goalkeeper->id]) }}">
                            <div class="circular--portrait-players-list">
                                <img
                                    src="{{ isset($goalkeeper->image)? asset('storage/' . $goalkeeper->image) : asset('/storage/blank-profile-picture.png') }}"
                        ...
                        <div class="player-list-text mt-2 mb-3 mb-lg-1">
                            ...
                            @endif
                            <span><i
                                    class="fas fa-stopwatch"></i> {{ $goalkeeper->played_matches ?? '' }}</span>
                        </div>
                    </div>
                @endforeach
                <div class="col-12">
                ...
                @foreach ($defenders as $defender)
                    <div class="col-12 col-lg" data-aos="zoom-in-down" data-aos-duration="1000">
                        <a href="{{ route('season.players.show', ['player' => $defender->id]) }}">
                            <div class="circular--portrait-players-list">
                                <img
                                    src="{{ isset($defender->image)? asset('storage/' . $defender->image) : asset('/storage/blank-profile-picture.png') }}"
                                    class="img-scorer" alt="Zdjęcie gracza">
                            </div>
                        </a>
                        <div class="player-list-text mt-2 mb-3 mb-lg-1">
                            ...
                            @endif
                            <span><i
                                    class="fas fa-stopwatch"></i> {{ $defender->played_matches ?? '' }}</span>
                        </div>
                    </div>
                @endforeach
                <div class="col-12">
                ...
                @foreach ($midfielders as $midfielder)
                    <div class="col-12 col-lg" data-aos="zoom-in-up" data-aos-duration="1000">
                        <a href="{{ route('season.players.show', ['player' => $midfielder->id]) }}">
                            <div class="circular--portrait-players-list">
                                <img
                                    src="{{ isset($midfielder->image)? asset('storage/' . $midfielder->image) : asset('/storage/blank-profile-picture.png') }}"
                                    class="img-scorer" alt="Zdjęcie gracza">
                            </div>
                        </a>
                        <div class="player-list-text mt-2 mb-3 mb-lg-1">
                            ...
                            @endif
                            <span><i
                                    class="fas fa-stopwatch"></i> {{ $midfielder->played_matches ?? '' }}</span>
                        </div>
                    </div>
                @endforeach
                <div class="col-12">
                ...
                @foreach ($strikers as $striker)
                    <div class="col-12 col-lg" data-aos="fade-up" data-aos-duration="1000">
                        <a href="{{ route('season.players.show', ['player' => $striker->id]) }}">
                            <div class="circular--portrait-players-list">
                                <img
                                    src="{{ isset($striker->image)? asset('storage/' . $striker->image) : asset('/storage/blank-profile-picture.png') }}"
                                    class="img-scorer" alt="Zdjęcie gracza">
                            </div>
                        </a>
                        <div class="player-list-text mt-2 mb-3 mb-lg-1">
                            ...
                            @endif
                            <span><i
                                    class="fas fa-stopwatch"></i> {{ $striker->played_matches ?? '' }}</span>
                        </div>
                    </div>
                @endforeach
        </div>
